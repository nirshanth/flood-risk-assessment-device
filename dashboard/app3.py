...
def calculate_combined_risk(sensor_data, weather_data):
    ...
    # Using first 2 daily forecast blocks as near-term risk estimate
    next_24h = forecast[:2]
        ...
        <div id="floodTab" class="tab-panel active">
            <div class="cards-grid">
                <div class="panel">
                    ...
                    <div class="card-foot">Analog reading from water sensor</div>
                </div>
                ...
                <div class="panel">
                    ...
                    <div class="card-foot">Derived from local sensor thresholds</div>
                </div>
